  ...
  return (
    <section className='w-full h-full relative bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 md:bg-none'>
      <section className='w-full h-[94.5vh]'>
        <img className='w-full h-full z-10 md:block hidden shadow-top-md object-contain' src={registration} alt='sml-scren-bg'/>

        <div className='absolute w-full h-full md:w-fit md:h-fit md:p-4 md:top-5 md:right-40 top-0 right-0 p-10 rounded-md shadow-2xl bg-transparent hover:-translate-y-2 duration-500 ease-in-out'>
            ...
            <form className='mt-5 text-center w-full' onSubmit={handleSubmit}>
                ...
                <section className='mb-5 md:pr-10'>
                    <div className='w-full text-end'>
                        <NavLink to={'/login'} className='cursor-pointer inline-block hover:underline text-black'>already have an account?</NavLink>
                    </div>
