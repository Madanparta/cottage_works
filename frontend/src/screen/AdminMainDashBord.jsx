...
const AdminMainDashBord = ({info,index,feedback,feedbackShow}) => {
  ...
  return (
    <>
        ...
        <td onClick={openDialog} className="border w-2/12 whitespace-nowrap py-1 hover:bg-gray-700 active:bg-gray-600">{role === 'homepreneur' ? feedback.feedback.length >= 20 ? feedback.feedback.slice(0,20)+"..." : feedback.feedback : "---"}</td>
