...
const Header = () => {
  ...
  return (
    <section className='w-full flex justify-between items-center border py-2 px-4 sm:px-4 md:px-10 sticky top-0 left-0 shadow-lg bg-transparent z-50'>
      <div className=''>
    ...
    {showManu && <div className="w-full h-screen absolute top-0 left-0 flex justify-center items-center flex-col gap-5 capitalize md:hidden bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r text-white">
      ...
      <NavLink to='register' className="hover:font-medium hover:underline drop-shadow cursor-pointer">register</NavLink>
      <NavLink to='login' className="hover:font-medium hover:underline drop-shadow cursor-pointer">login</NavLink>
    </div>}

      <nav className='text-lg font-extralight drop-shadow hidden md:block'>
        <p><NavLink to='register' className="cursor-pointer hover:text-blue-800">register</NavLink>/<NavLink to='login' className="cursor-pointer hover:text-blue-800">login</NavLink></p>
      </nav>
    </section>
  )
}
