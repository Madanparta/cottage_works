    ...
    {showManu && <div className="w-full h-screen absolute top-0 left-0 flex justify-center items-center flex-col gap-5 capitalize md:hidden bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r text-white">
      ...
      <nav className='text-lg font-extralight drop-shadow hidden md:block'>
        ...
        (<div className="flex flex-row gap-3">
          <NavLink className="transition rounded-sm py-0 px-2 ease-in-out duration-300 hover:text-white hover:bg-indigo-500 hover:-translate-y-1 hover:scale-100">About</NavLink>
          <NavLink to='/login' onClick={handleHomepreneurButton} className="transition rounded-sm py-0 px-2 ease-in-out duration-300 hover:text-white hover:bg-indigo-500 hover:-translate-y-1 hover:scale-100">Homepreneur</NavLink>
          <NavLink to='/login' onClick={handleInvesterButton} className="transition rounded-sm py-0 px-2 ease-in-out duration-300 hover:text-white hover:bg-indigo-500 hover:-translate-y-1 hover:scale-100">Investor</NavLink>
